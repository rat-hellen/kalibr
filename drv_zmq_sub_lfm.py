...
class Zmq_Sub: 
    ...
    def __init__(self, name_measurement, async_reader, binding_=bind_to): 
    ...
    async def subscribe(self):
        ...
        while (True):
            ...
            if (self.is_message_for_vfd(msg) == False):
                decoded_label = self.decode_message_ToLabel(msg)
                self.async_reader.setLastSubReadLabel_lfm(decoded_label)
