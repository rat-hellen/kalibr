...
class Dataclass_Reader_Sync: 
    ...
    def __init__(self, name_measurement_= name_measurement, port_=port,baudrate_=baudrate,bytesize_=bytesize,
                 parity_=parity, stopbits_=stopbits, timeout_=timeout, write_timeout_=write_timeout,xonxoff_=xonxoff,rtscts_=rtscts,dsrdtr_=dsrdtr): 
        ...
        self.write_timeout=write_timeout_
